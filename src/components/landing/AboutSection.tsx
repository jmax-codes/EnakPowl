  ...
  return (
    ...
    >
      <div className="max-w-5xl relative">
        ...
        <p ref={containerRef} className="text-4xl md:text-6xl font-black tracking-tighter leading-[0.9] uppercase flex flex-wrap gap-x-4 gap-y-2">
          {words.map((word, i) => (
            <Word 
              key={i} 
              word={word} 
